const en = {
  ...
  settingsPageDescription: 'Find and adjust dashboard, core, and feature behavior by category.',
  ...
  configurePorts: 'Configure listening ports',
  dnsQueryDescription: 'Query DNS results and IP information',
  overviewCardVisibilityDescription: 'Control whether this card appears on the overview page',
  ports: 'Ports',
  actions: 'Actions',
