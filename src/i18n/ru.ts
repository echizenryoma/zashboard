...
const ru: LANG_MESSAGE = {
  ...
  settingsPageDescription: 'Настройки панели, ядра и функций по категориям.',
  ...
  configurePorts: 'Настроить порты',
  dnsQueryDescription: 'Запрос результатов DNS и сведений об IP',
  overviewCardVisibilityDescription: 'Показывать эту карточку на странице обзора',
  ports: 'Порты',
  actions: 'Действия',
