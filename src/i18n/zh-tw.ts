...
const zhTW: LANG_MESSAGE = {
  ...
  importFromBackendTip:
    '預設的 ./zashboard-settings.json 位於 ui 資料夾下，匯入前請確保 ui 資料夾下存在該設定檔案。',
  importFailed: '匯入失敗，請檢查 URL {url}',
  autoImportFromUrl: '自動從 URL 匯入設定',
  autoImportFromUrlTip:
    '啟用後，每次開啟 zashboard 時會自動從 URL 匯入設定並計算 hash，如果 hash 與上次匯入的不同，則重新匯入並重新整理頁面。',
  getting: '獲取中...',
