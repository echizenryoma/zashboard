    ...
    >
      <Transition name="backend-switch">
        <div
          v-if="isOpen"
          ref="panelRef"
          class="border-base-border bg-base-100 need-blur fixed z-[998] flex flex-col gap-1 overflow-hidden rounded-lg border p-1 shadow-lg"
          :style="panelStyle"
        >
          <div
      ...
      <Transition name="backend-switch">
        <div
          ...
          ref="actionsPanelRef"
          class="border-base-border bg-base-100 need-blur fixed z-[998] flex flex-col gap-1 overflow-y-auto rounded-lg border p-1 shadow-lg"
